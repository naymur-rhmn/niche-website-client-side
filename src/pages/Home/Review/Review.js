...
const Review = () => {
  ...
  useEffect(() => {
    fetch('https://mountain-bike-server.onrender.com/reviews')
      .then((res) => res.json())
        ...
        <Box sx={{ paddingTop: 10, paddingBottom: 10 }}>
          <Box sx={{ textAlign: 'center', padding: '0 30px', marginBottom: 8 }}>
            ...
            <Typography
              ...
              variant='body1'
            >
              Morbideli ornare at mauris in aliquam ut tellus.Ut pharetra sed
              velit et sapien eros scelerisque. Morbideli ornare at mauris in
              aliquam ut tellus.Ut pharetra sed velit et sapien eros
              scelerisque.
            </Typography>
          </Box>
            ...
            {reviews.map((review) => (
              <Grid key={review.name} item lg={4} md={4} sm={6} xs={12}>
                <Box>
                  ...
                  <Typography color='green' align='center' variant='body2'>
                    {review.profession}
                  </Typography>
                </Box>
              </Grid>
